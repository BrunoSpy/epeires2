...
class FieldsController extends FormController
{
    ...
    public function saveAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid()) {
                $customfield->setCategory($objectManager->getRepository('Application\Entity\Category')
                    ->find($post['category']));
                if ($id) {
    ...
    private function getForm($id = null, $categoryid = null)
    {
        ...
        $form->setHydrator(new DoctrineObject($objectManager))->setObject($customfield);
        ...
        $form->get('type')->setValueOptions($objectManager->getRepository('Application\Entity\CustomFieldType')
            ->getAllAsArray());
