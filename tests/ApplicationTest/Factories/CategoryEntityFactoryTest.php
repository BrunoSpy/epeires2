...
class CategoryEntityFactoryTest extends TestCase
{
    public function testCreateMilCategory() {
        $milcategory = $this->getCategoryService()->createMilCategory();
        ...
        $this->getEntityManager()->persist($milcategory);
